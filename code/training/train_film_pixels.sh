...
This script will train FiLM using pixel features for:
 4 tasks: a, b, c, d
 3 runs: 1 2 3
 4 learning rates: 5e-5, 5e-4, 5e-3, 3e-4
 2 dropout values: 0, 0.5
 2 classifier batchnorm values: 0, 1
and will save all models in './saved_models/film_pixels/'
...
do
                   ...
                   python scripts/train_model.py \
                     ...
                     --train_features_h5 ../data/${el}_dataset/visual_features/train_features_raw.h5 \
                     --val_question_h5 ../data/${el}_dataset/val_questions.h5 \
                     --val_features_h5 ../data/${el}_dataset/visual_features/val_features_raw.h5 \
                     ...
                     --checkpoint_path ./saved_models/film_pixels/${el}_${m}_drop${dr}_bn${bn}_lr${lr}_run${i}.pt
